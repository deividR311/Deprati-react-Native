...
export const DepratiEmarsysPDPReferencesComponent = (props: Props) => {
  const { customProps, contentProduct } = props;
...
export default DepratiEmarsysPDPReferencesComponent;
